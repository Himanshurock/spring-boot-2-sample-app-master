 ...
 * 
 * 
 * class Student { String firstName; String lastName; public String
 ...
 * 
 * 
 * @Test public void mongoTest() {
 * System.out.println("=============MongTestIT==========="); Student stud = new
 * Student(); stud.setFirstName("Test"); stud.setLastName("Mongo");
